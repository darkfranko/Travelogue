...
class AddEntryViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    //Show or hide the camera and delete icons
    ...
    //Image Picker Controller. Handle here what to do with the picked image
...
let info = convertFromUIImagePickerControllerInfoKeyDictionary(info)
    ...
    @IBAction func saveEntry(_ sender: Any) {
        ...
        !entryTitle.isEmpty, !entryContents.isEmpty else {
            let alert = UIAlertController(title: "Warning", message: "You must include a title and description!", preferredStyle: UIAlertController.Style.alert)
